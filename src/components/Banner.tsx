      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-[65px] font-bold text-gray-900 leading-tight mb-2">
              We manage your IT,
              <span className="text-[#1090af]">
                so you can grow your business.
              </span>
            </h1>
            <p className="text-lg text-gray-600 mb-4 max-w-lg mx-auto md:mx-0">
              Leave the complexity to us. Focus on your priorities.
            </p>
          ...
          <div className="flex-1">
            <div className="relative w-full h-80 md:h-[450px] lg:h-[500px] rounded-2xl overflow-hidden shadow-xl">
              <Image
                src={bannerImage}
